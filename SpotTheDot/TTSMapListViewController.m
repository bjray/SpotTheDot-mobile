...
@interface TTSMapListViewController ()

@end

@implementation TTSMapListViewController
...
- (void)viewDidLoad
{
    ...
    self.dataSource = [appDelegate dataSourceForContext:TTSDataContextMap];
    self.dataSource.subsetId = self.categoryId;
    [self.dataSource refreshDataSource];
    
    [self.tableView reloadData];
    
    NSLog(@"Map categoryId: %@", self.categoryId);
...
{
    NSInteger rows = [self.dataSource numberOfObjectsInSection:section];
    
    NSLog(@"MapList: # of rows: %d", rows);
    return rows;
}
